...
from utils_exp import get_prompt, str2bool, sanitize_filename
...
if __name__ == '__main__':
    ...
    parser.add_argument('--models_path', help='method of prompting', type=str, required=True, default='final-models')
