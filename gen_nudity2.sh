...
# =============================================================================
# Train (cross-attention-only LoRA variant: LoRA injected into attn2 layers only)
# =============================================================================
# export CONCEPT="human_20_prompts_clothes"
# accelerate launch src/train_ace_diverse2.py \
...
export MODEL_NAME="ACE_lora_human_20_prompts_clothes-sc_-ng_3.0-iter_1500-lr_0.001-lora-prior_2_tr_null_True_nc_False_no_cer_sur_True_tensor_False_nw_0.99_pl_0.8_sg_new_3.0_is_sc_clip_False_attn2"
